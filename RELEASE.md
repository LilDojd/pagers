...
2. Push the changes: `jj git push -b main`
3. Check if [CI](https://github.com/LilDojd/pagers/actions) workflow completes successfully.
4. Push the tag: `git push origin v[X.Y.Z]`
5. Wait for [Release](https://github.com/LilDojd/pagers/actions) workflow to finish.
