...
## [0.2.3](https://github.com/LilDojd/pagers/compare/v0.2.2...v0.2.3) - 2026-09-16

### Other

- update Cargo.lock dependencies
- *(deps)* Bump dua-core from 3.3.1 to 4.1.0 ([#70](https://github.com/LilDojd/pagers/pull/70))
...
- *(core)* synchronize traversal cancellation

## [0.2.1](https://github.com/LilDojd/pagers/compare/v0.2.0...v0.2.1) - 2026-08-10

### Other

- document container registries
